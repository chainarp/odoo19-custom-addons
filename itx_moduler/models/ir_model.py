...
from ..controllers.main import MAGIC_FIELDS
...
class IrModelServerConstrain(models.Model):
    ...
    _description = 'ITX Moduler Model Server Constrains'
    ...
    def _instanciate(self, model_data):
        ...
        try:
            ...
            if 'm2o_inherit_py_class' in model_data and model_data['m2o_inherit_py_class']:
                ...
                try:
                    py_class = self.env['itx.moduler.pyclass'].browse(model_data['m2o_inherit_py_class'])
